...
const engagementEntryPredicate = namedNode(
  "http://mu.semte.ch/vocabularies/ext/engagementEntry"
);
const existingStaffPredicate = namedNode(
  "http://mu.semte.ch/vocabularies/ext/existingStaff"
);
const additionalStaffPredicate = namedNode(
  "http://mu.semte.ch/vocabularies/ext/additionalStaff"
);
const volunteersPredicate = namedNode(
  ...
  engagementEntries
    ...
    .forEach((entry) => {
      ...
      const hasRequiredTriples = hasTriples(
        entry,
        [existingStaffPredicate, additionalStaffPredicate, volunteersPredicate],
        store,
        sourceGraph
      );
