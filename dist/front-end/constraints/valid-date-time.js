...
function validDateTimeString(value) {
  ...
  //Source of this ugyl expression https://www.oreilly.com/library/view/regular-expressions-cookbook/9781449327453/ch04s07.html
  const xsdDateTimeRegex = new RegExp(`^(-?(?:[1-9][0-9]*)?[0-9]{4})-(1[0-2]|0[1-9])-(3[01]|0[1-9]|[12][0-9])T(2[0-3]|[01][0-9]):([0-5][0-9]):([0-5][0-9])(\.[0-9]+)?(Z|[+-](?:2[0-3]|[01][0-9])(:?[0-5][0-9])?)?$`); //To make sure the regex after this one does not break existing stuff. I keep this check here
