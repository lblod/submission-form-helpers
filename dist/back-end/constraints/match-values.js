...
exports.default = constraintMatchValues;
 ...
 */
function constraintMatchValues(values, options) {
  const {
    constraintUri,
    store
  } = options;
  const targetValuesIn = store.match(constraintUri, (0, _namespaces.FORM)('valuesIn'), undefined);
  const targetValuesNotIn = store.match(constraintUri, (0, _namespaces.FORM)('valuesNotIn'), undefined);
